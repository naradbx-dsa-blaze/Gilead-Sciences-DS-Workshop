...
# MAGIC To run this demo, just select the cluster `dbdemos-lakehouse-hls-readmission-narasimha_kamathardi` from the dropdown menu ([open cluster configuration](https://e2-demo-field-eng.cloud.databricks.com/#setting/clusters/0712-160344-bktms607/configuration)). <br />
...
# MAGIC %run ../_resources/00-setup $reset_all_data=false $catalog=nara_catalog $db=gilead_de_workshop
...
# MAGIC <img width="1px" src="https://ppxrzfxige.execute-api.us-west-2.amazonaws.com/v1/analytics?category=lakehouse&org_id=1444828305810485&notebook=%2F03-Data-Analysis-BI-Warehousing%2F03-Data-Analysis-BI-Warehousing-patient-readmission&demo_name=lakehouse-hls-readmission&event=VIEW&path=%2F_dbdemos%2Flakehouse%2Flakehouse-hls-readmission%2F03-Data-Analysis-BI-Warehousing%2F03-Data-Analysis-BI-Warehousing-patient-readmission&version=1">
...
# MAGIC %md
# MAGIC
# MAGIC Open the <a href="/sql/dashboards/01a8c547-9d86-4a4e-b1da-4bc92d1e5e16" target="_blank">Cohort patient analysis Dashboard</a> to start reviewing our cohort data.
