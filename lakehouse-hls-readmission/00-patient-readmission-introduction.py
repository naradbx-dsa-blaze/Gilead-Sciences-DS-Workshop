...
# MAGIC <img width="1px" src="https://ppxrzfxige.execute-api.us-west-2.amazonaws.com/v1/analytics?category=lakehouse&org_id=1444828305810485&notebook=%2F00-patient-readmission-introduction&demo_name=lakehouse-hls-readmission&event=VIEW&path=%2F_dbdemos%2Flakehouse%2Flakehouse-hls-readmission%2F00-patient-readmission-introduction&version=1">
...
# MAGIC %md 
# MAGIC
# MAGIC Open the HLS patient readmission  <a dbdemos-pipeline-id="dlt-patient-readmission" href="#joblist/pipelines/437f4569-5be0-49bb-ad73-59150b22f45d" target="_blank">Delta Live Table pipeline</a> or the [SQL notebook]($./01-Data-Ingestion/01.1-DLT-patient-readmission-SQL) *(python DLT notebook alternative coming soon).* <br>
...
# MAGIC %md 
# MAGIC
# MAGIC Open the [Clinical Data Analysis notebook]($./03-Data-Analysis-BI-Warehousing/03-Data-Analysis-BI-Warehousing-patient-readmission) to start building your cohorts or directly open the <a href="/sql/dashboards/01a8c547-9d86-4a4e-b1da-4bc92d1e5e16" target="_blank">Patient analysis dashboard</a>
